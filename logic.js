...
var firstPerson = 'MITHUN'; // Replace with the actual name
var firstLocation = 'TUMKUR, India'; // Replace with the actual location

var secondPerson = 'PRAGATHI'; // Replace with the actual name
var secondLocation = 'tumkur, India';
...
var timeLeaveStamp = new Date(2025, 01, 03);

//first day of renewed contact (year, month, day)
var timeMeetStamp = new Date(2026, 1, 06);
